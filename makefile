...
# Build
#
build: build-core build-json build-kinesis build-cloudwatch build-els build-jvm-metrics build-kafka build-slack build-zipkin build-prometheus build-examples
