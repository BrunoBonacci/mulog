...
# Build
#
build: build-core build-json build-cloudwatch build-kinesis build-els build-jvm-metrics build-kafka build-slack build-zipkin build-prometheus build-examples
